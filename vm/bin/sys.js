...
//@ts-ignore
var systemNetworkAsAxios = function () { return _SYSTEM_AXIOS.axios; };
var axios = systemNetworkAsAxios();
...
var Call = /** @class */ (function () {
     ...
     * @param headers
     */
    function Call(url, name, description, exampleBody, headers) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        config = {
                            url: this.url,
                            data: body,
                            headers: __assign(__assign({ 'Content-Type': 'application/json' }, this._headers), headers),
                            method: 'POST'
                        };
...
var TypedModule = /** @class */ (function (_super) {
    __extends(TypedModule, _super);
    function TypedModule(configs) {
        var _this = _super.call(this) || this;
        _this._configs = configs;
        return _this;
    }
    TypedModule.prototype.getConfig = function (name) {
    ...
    TypedModule.prototype.create = function (value) {
...
var HuggingFaceModule = /** @class */ (function (_super) {
    __extends(HuggingFaceModule, _super);
    function HuggingFaceModule() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HuggingFaceModule.prototype.create = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (occurrences(this.getConfig('model'), '/') != 1) {
                    throw "Incorrectly passed model path-name";
                }
                return [2 /*return*/, new Call("https://api-inference.huggingface.co/models/".concat(this.getConfig('model')), "", "", {
                        inputs: "string"
                    }, {
                        "Authorization": "Bearer ".concat(this.getConfig("token"))
                    })];
            });
        });
    };
...
var ModulesKit = {
     ...
     */
    huggingFace: function (configs) { return new HuggingFaceModule(configs); },
    bm3d_horizon: {
        listen: new Call("http://62.197.49.215:1101/opt/brain/listen", "bm3d Horizon", "", {
            "body": "Hello, I am a John!",
            "namespace": "DIALOG_ID or USER_ID"
        }),
        find: new Call("http://62.197.49.215:1101/opt/brain/find", "bm3d Horizon", "", {
            "body": "Hello, I am a John!",
            "namespace": "DIALOG_ID or USER_ID"
        })
    }
...
$foundation = {
    ...
    $schedule: {
         ...
         */
        create: function (time, link) {
            if (!self$1['$schedule'] || !self$1['$schedule'].hasOwnProperty(link)) {
                throw "You are trying to register a job with a reference to a non-existent object in the schedule repository. $schedule.".concat(link, " not found");
            }
            //@ts-ignore
            SYSTEM.createScheduleJob(time, link);
        }
    },
    $modules: function () { return ModulesKit; },
    $object: {
        /**
    ...
    $array: {
         ...
         */
        asHuggingFaceGeneratedText: function (array, removeThis) {
            if (removeThis === void 0) { removeThis = ''; }
         ...
         */
        asConversation: function (array, isCompact, answerRequest) {
            if (isCompact === void 0) { isCompact = true; }
            if (answerRequest === void 0) { answerRequest = true; }
            if (answerRequest) {
                array.push({
                    role: 'assistant',
                    content: '',
    ...
    $dialog: {
         ...
         */
        replyWithText: function (_a) {
            var _b;
            var dialogId = _a.dialogId, text = _a.text;
            if (!text || !dialogId) {
                return null;
            }
            // @ts-ignore
            (_b = (SYSTEM || null)) === null || _b === void 0 ? void 0 : _b.answerPlainText({
                dialogId: dialogId,
                text: text.trim(),
            });
            return null;
        },
        replyWithGif: function (_a) {
            var _b;
            var dialogId = _a.dialogId, src = _a.src, alt = _a.alt;
            if (!src || !dialogId) {
                return null;
            }
            // @ts-ignore
            (_b = (SYSTEM || null)) === null || _b === void 0 ? void 0 : _b.answerGif({
                dialogId: dialogId,
                src: src,
                gifDescription: alt,
            });
...
function safeSignal(functionName, context, args) {
    ...
    if (context && context[functionName] != null) {
        ...
        stdout("s(".concat(functionName, "): success"));
        return results;
    }
    else {
        stdout("safeSignal ->>> (".concat(functionName, "): not found"));
    }
}
...
var Character = /** @class */ (function () {
    ...
    Character.prototype.serialize = function () {
        var builder = ["You are ".concat(this.role)];
        if (this.name) {
            builder.push("Your name is ".concat(this.name));
        }
